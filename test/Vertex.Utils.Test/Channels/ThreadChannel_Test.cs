...
namespace Vertex.Utils.Test.Channels
{
    public class ThreadChannel_Test
    {
        ...
        {
            var channel = serviceProvider.GetService<ThreadChannel<string>>();
        ...
        {
            var channel = serviceProvider.GetService<ThreadChannel<string>>();
            var channel_1 = serviceProvider.GetService<ThreadChannel<string>>();
        ...
        public async Task Sequence_Consumer()
        {
            var channel = serviceProvider.GetService<ThreadChannel<string>>();
            var channel_1 = serviceProvider.GetService<ThreadChannel<string>>();
            var channel_2 = serviceProvider.GetService<ThreadChannel<string>>();
            var channel_3 = serviceProvider.GetService<ThreadChannel<string>>();
            var consumerTask = new TaskCompletionSource();
