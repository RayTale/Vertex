...
{
    public class TxUnitSnapshotHandler<PrimaryKey, TInput> : SnapshotHandlerBase<PrimaryKey, TxUnitSnapshot<TInput>>
    {
        ...
        {
            var data = serializer.Deserialize<TInput>(evt.Data);
